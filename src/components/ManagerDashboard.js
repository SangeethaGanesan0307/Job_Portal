...
//       <PendingApprovals />
//       <TeamApplications />
//       {/* ApprovalHistoryModal can be shown based on your history-view modal logic. 
//         You can place it always here with a useState open prop, or render it from inside TeamApplications if only used there. */}
//       <ApprovalHistory />
//     </Box>
//   );
// };
